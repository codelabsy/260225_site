...
// Check permission
$record = ShoppingDB::find($targetId);
if (!$record) {
...
try {
    $memoId = Memo::create(TARGET_SHOPPING, $targetId, $user['id'], $content);
    ...
    error_log('Shopping memo error: ' . $e->getMessage());

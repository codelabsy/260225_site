<?php
/**
 * Shopping DB detail API.
 * GET: id
 * Returns basic info + status history + memos.
 */
...
try {
    ...
    $statusHistories = StatusHistory::getByTarget(TARGET_SHOPPING, $id);
    $memos = Memo::getByTarget(TARGET_SHOPPING, $id);

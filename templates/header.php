...
<head>
    ...
    <title><?= isset($pageTitle) ? htmlspecialchars($pageTitle) . ' - ERP+CRM' : 'ERP+CRM' ?></title>
    ...
    <nav class="bg-slate-900 text-white shadow-lg sticky top-0 z-50">
        <div class="max-w-screen-2xl mx-auto px-4">
            <div class="flex items-center justify-between h-14">
                ...
                <div class="flex-shrink-0">
                    <a href="/dashboard.php" class="text-lg font-bold tracking-tight text-white hover:text-blue-300 transition-colors">
                        ERP+CRM
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-slate-800">
            <div class="px-4 py-3 space-y-1">
                <a href="/dashboard.php" class="mobile-nav-link <?= $currentPage === 'dashboard' ? 'mobile-nav-link-active' : '' ?>">대시보드</a>
                <a href="/erp.php" class="mobile-nav-link <?= $currentPage === 'erp' ? 'mobile-nav-link-active' : '' ?>">ERP매출</a>
                <a href="/shopping.php" class="mobile-nav-link <?= $currentPage === 'shopping' ? 'mobile-nav-link-active' : '' ?>">쇼핑DB</a>
                <a href="/place.php" class="mobile-nav-link <?= $currentPage === 'place' ? 'mobile-nav-link-active' : '' ?>">플레이스DB</a>
                <a href="/stats.php" class="mobile-nav-link <?= $currentPage === 'stats' ? 'mobile-nav-link-active' : '' ?>">통계</a>
                <?php if ($isAdmin): ?>
                <div class="border-t border-slate-800 my-2"></div>
                <a href="/employees.php" class="mobile-nav-link <?= $currentPage === 'employees' ? 'mobile-nav-link-active' : '' ?>">직원관리</a>
                <a href="/activity-log.php" class="mobile-nav-link <?= $currentPage === 'activity-log' ? 'mobile-nav-link-active' : '' ?>">활동로그</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
